...
export class HomePage extends BasePage {
    hotelsCategory: Locator;
    locationTrigger: Locator;
    locationInput: Locator;
    searchResultMiami: Locator;
    datesTrigger: Locator;
    guestsTrigger: Locator;
    searchButton: Locator;

  constructor(page: Page) {
    super(page);
    this.hotelsCategory = page.getByTestId("category-search-bar-tab(static:hotels)");
    this.locationTrigger = page.getByTestId("category(static:hotels)_search-form_location_trigger");
    this.locationInput = page.getByTestId("category(static:hotels)_search-form_location_input");
    this.searchResultMiami = page.getByRole("button", { name: "Miami Miami, FL, USA" });
    this.datesTrigger = page.getByTestId("category(static:hotels)_search-form_dates_trigger");
    this.guestsTrigger = page.getByTestId("category(static:hotels)_search-form_guests_trigger");
    this.searchButton = page.getByTestId("category(static:hotels)_search-form_search-button");
  }
  ...
  async selectDates(): Promise<void> {
    ...
    await this.page.getByTestId("category(static:hotels)_search-form_dates_apply-button").click();
  }
